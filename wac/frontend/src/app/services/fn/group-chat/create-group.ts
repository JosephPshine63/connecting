...
export function createGroup(http: HttpClient, rootUrl: string, params: CreateGroup$Params, context?: HttpContext): Observable<StrictHttpResponse<ChatResponse>> {
...
createGroup.PATH = '/api/v1/chats/groups';
