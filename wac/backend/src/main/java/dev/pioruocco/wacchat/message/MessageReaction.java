...
public class MessageReaction extends BaseAuditingEntity {
    ...
    @Id
    @SequenceGenerator(name = "message_reactions_seq", sequenceName = "message_reactions_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "message_reactions_seq")
    private Long id;
