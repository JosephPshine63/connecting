...
echo ""
echo " Start notification-service (terminal 2):"
...
echo ""
echo " Start call-service (terminal 3):"
echo "   cd wac/call-service && ./mvnw spring-boot:run"
echo "   (connects to RabbitMQ on localhost:5672 and backend:8082 by default)"
echo ""
